...
Secondly, run linear regression on each relationship with the added dimension Northern Hemisphere (greater than or equal to 0 degrees latitude) and Southern Hemisphere (less than 0 degrees latitude):
